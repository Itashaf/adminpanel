...
import { getTeacherClassScope } from './roleGuard';
...
// on the admin dashboard above. getTeacherClassScope merges in classTeacherOf
// too — currentUser.assignedClasses alone left a Class Teacher with zero
// subject assignments of their own seeing an empty "My Classes"/"My
// Students" dashboard for their own homeroom.
export async function getTeacherDashboardOverview(currentUser) {
  const assignedClasses = getTeacherClassScope(currentUser);
