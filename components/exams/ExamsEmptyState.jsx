...
export default function ExamsEmptyState({ onCreateExam }) {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-12 text-center">
      ...
      <p className="text-sm text-gray-500 mt-1.5 max-w-sm mx-auto">
        {onCreateExam
          ? 'Create your first exam to start setting up a date sheet and collecting marks.'
          : 'No exams have been created yet for the classes you teach.'}
      </p>
      {onCreateExam && (
        <button
          type="button"
