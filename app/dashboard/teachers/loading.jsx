// Mirrors TeachersExplorer.jsx's real layout (header + 4 stat cards +
// filter toolbar + table) — same bespoke-skeleton convention as
...
function TableRowSkeleton() {
  return (
    <tr className="border-t border-gray-100">
      ...
      <td className="py-4 pr-4"><div className="h-5 w-14 bg-gray-100 rounded-full animate-pulse" /></td>
